        ...
        this.state.matcheslist ?
            <NodeGroup
                ...
                enter={(d,i)=>({
                    opacity:[1],
                    x:[0],
                    timing:{duration: 1000, delay: i * 50, ease: easePolyOut}
                })}
                        ...
                        { nodes.map(({key, data, state:{x, opacity}})=>(
                            ...
                            >
                                <div className="block_wraper">
                                    <div className="block">
                                        <div 
                                            className="icon" 
                                            style={{
                                                background: `url(/images/team_iconsNFL/${data.awayThmb}.png)`
                                            }}
                                        ></div>
                                    ...
                                    <div className="block">
                                        <div 
                                            className="icon" 
                                            style={{
                                                background: `url(/images/team_iconsNFL/${data.localThmb}.png)`
                                            }}
                                        ></div>
                                ...
                                <div className="block_wraper nfo">
                                    <div><strong>Date: </strong><Moment format='LL'>{data.date}</Moment></div>
